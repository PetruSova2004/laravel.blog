...
$config['authentication'] = function () {
    // $_SERVER['DOCUMENT_ROOT'] - это корневая папка проектов
    require $_SERVER['DOCUMENT_ROOT'] . '/vendor/autoload.php'; // подключаем авто загрузчик
    ...
    if (!$app['auth']->check() || !$app['auth']->user()->is_admin){ // если пользователь не авторизован и у него нет роли администратора, то мы запрещаем ему доступ в наш ckfinder
