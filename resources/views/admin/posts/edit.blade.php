            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form role="form" method="post" action="{{ route('posts.update', ['post' => $post->id]) }}" enctype="multipart/form-data"> <!-- вторым аргументом в route мы передаем какой именно Пост мы редактируем -->
                            @csrf
                            @method('PUT')
                            <div class="card-body">
